...
import cz.metacentrum.perun.spRegistration.persistence.configuration.RpcConnectorProperties;
...
public class PerunConnectorRpc {
     ...
     */
    public JsonNode call(String manager, String method, Map<String, Object> map)
